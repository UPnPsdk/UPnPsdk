...
// Redistribution only with this Copyright remark. Last modified: 2026-08-08
/*!
 * \file
...
// ----------------------------------------------------------------------
CAddrinfo2::CAddrinfo2(const int a_flags, const int a_socktype) noexcept {
...
// ----------
/// \cond
CAddrinfo2::~CAddrinfo2() noexcept {
    if (m_res != nullptr) {
...
//
int CAddrinfo2::get_first(SInaddr a_inaddr) {
    if (m_res != nullptr)
