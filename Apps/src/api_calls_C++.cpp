...
// Redistribution only with this Copyright remark. Last modified: 2025-06-17
/*!
 * \file
...
int UpnpInit2(bool execute = true) {
    ...
    if (!execute) {
        fprintf(stderr, "Skip %s due to failed execution\n", function_name);
        return 0;
    }
    ...
    if (ret != UPNP_E_SUCCESS) {
        fprintf(stderr, "Unexpected: ::UpnpInit2() == %d\n", function_name);
        ::UpnpFinish();
        return 1;
    }
    ::UpnpFinish();
