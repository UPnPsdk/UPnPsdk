...
class UPnPsdk_VIS StdioMock : public umock::StdioInterface {
  public:
    StdioMock();
    ...
    MOCK_METHOD(int, feof, (FILE * stream), (override));
    MOCK_METHOD(int, ferror, (FILE * stream), (override));
    MOCK_METHOD(void, clearerr, (FILE * stream), (override));
    ENABLE_MSVC_WARN
};
// clang-format on
