 ...
 * CAddrinfo2 ai2Obj(AI_PASSIVE, SOCK_DGRAM);
...
class UPnPsdk_API CAddrinfo2 {
  public:
    ...
    CAddrinfo2(
        ...
        const int a_socktype = SOCK_STREAM) noexcept; // DEbUG! Test SOCK_DGRAM
